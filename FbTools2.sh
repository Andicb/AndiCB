...
echo
echo  " ____________________-=[WELCOME TO ANDICB TOOLS]=-____________________" | lolcat
echo  "|                                                           |" | lolcat
echo  "|              Editor       : AndiCB                    |" | lolcat
echo  "|              Instagram    : a.candra.b             |" | lolcat
echo  "|              Wa           : 082117257600              |" | lolcat
